...
public static class EventLogger
{
	...
	internal static List<GameEvent> Events { get; private set; } = new List<GameEvent>();
	...
	public static void Log(GameEventType type, string message, string playerName = "", string roleName = "", string location = "")
	{
		if (IsEnabled)
		{
			...
			Debug.Log(Object.op_Implicit($"[EventLogger] {gameEvent.Type}: {gameEvent.Message}"));
		}
	}

...
public class ModMenuCrewPlugin : BasePlugin
{
	...
	public class DebuggerComponent : MonoBehaviour
	{
		...
		private TextMeshProUGUI CreateTMPText(RectTransform parent, string text, int fontSize, Color color, Vector2 anchoredPosition, Vector2 sizeDelta, TextAlignmentOptions alignment = 513)
		{
			//IL_0030: Unknown result type (might be due to invalid IL or missing references)

...
public static class GhostOpcode
{
	...
	public const byte TOOLTIP = 176;

	public const byte KEYBIND_HINT = 177;

	public const byte BADGE = 178;

	public const byte PROGRESS_BAR = 179;

	public const byte DIVIDER_LABEL = 180;

	public const byte ICON_BUTTON = 181;

	public const byte STAT_ROW = 182;

	public const byte ALERT_BOX = 183;

	public const byte TAB_BADGE_COUNT = 184;

	public const byte TEXT_INPUT_NUMERIC = 185;

	public const byte TEXT_INPUT_STRING = 186;

	public const byte SLIDER_INT = 187;

...
public class ApiValidationResponse
{
	...
	[JsonPropertyName("key_display")]
	public string KeyDisplay { get; set; }

	[JsonPropertyName("time_display")]
	...
	[JsonPropertyName("proof_ttl_seconds")]
	public long? ProofTtlSeconds { get; set; }
	...
	[JsonPropertyName("render_ttl_seconds")]
	public long? RenderTtlSeconds { get; set; }
	...
	internal EncryptedPayload UiPayload { get; set; }

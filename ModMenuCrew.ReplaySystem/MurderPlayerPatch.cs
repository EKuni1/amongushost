...
public static class MurderPlayerPatch
{
	public static void Prefix(PlayerControl __instance, PlayerControl target)
	{
		...
		{
			ReplayRecorder.Instance.LogEvent(ReplayEventType.Kill, __instance.PlayerId, target.PlayerId, Vector2.op_Implicit(((Component)target).transform.position), "Kill: " + __instance.Data.PlayerName + " -> " + target.Data.PlayerName);
		}
	}
}
